            ...
            <form id="form-config" class="config-form" action="">
                ...
                <div class="group-form">                    
                    <div class="switch-button">                      
                        <input type="checkbox" name="switch_email" id="switch-email" class="switch-button__checkbox" @isset($configs[0]->notificacion_email) checked @endisset>
                ...
                <div class="group-form">                    
                    <div class="switch-button">
                        <input type="checkbox" name="switch_music" id="switch-music" class="switch-button__checkbox" @isset($configs[0]->musica_fondo) checked @endisset>
